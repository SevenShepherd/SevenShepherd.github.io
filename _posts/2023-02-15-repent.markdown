...
<!-- <span style="font-style:Italic;font-size:21px;color:Black;">Conclusions</span> 

- Repentance is a heartfelt sorrow for sin, a renouncing of it, and sincere commitment to forsake it and walk in obedience to Christ.
- Faith is not merely an intellectual assent to facts.
- The Free Grace movement does not teach the Reformation doctrine of  *"Justification by faith alone"* (*sola fide*).
- Repentance from sin is necessary for saving faith.
- Good works and continuing to believe follow saving faith. -->

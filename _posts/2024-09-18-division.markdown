...
If something challenges established doctrine (e.g. [repentance as a turn](https://sevenshepherd.github.io/repent-means-turn/), or faith as trust), this new challenger group is the target of verses like Titus 3:8-11, 1Tim 6:3-4, and 2Tim 4:3-4 NET.

The defender (me in this instance) is only fulfilling his mandate and upholding established truths that have been taught for thousands of years, as we're commissioned to do.

...
- 🚫 In modern neotheologies, like the 80s "free grace" movement, salvation is by blind faith (evidenceless), which can lead to <a href="#dead">the false assurance of a dead faith</a>. I view these teachings as flirting with the heresy of [antinomianism](https://sevenshepherd.github.io/antinomian-heresy/).

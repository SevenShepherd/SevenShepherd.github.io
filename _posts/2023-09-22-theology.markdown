...
- 🚫 In Calvinist theology there's an arbitrary election of those to receive saving faith. Salvation, then, isn't based on faith alone, but by a random or arbitrary selection alone.
    - Hopefully you win the lottery. Good luck.
- 🚫 In Arminian theology salvation is prescient upon human free will and decision. So then salvation is not by faith alone, but by works and decisions alone. 
    - Hopefully you don't have <a href="#legal">legalistic false assurance</a>.
- 🚫 In modern neotheologies, like 80s "free grace" movement or progressive forms of Christianity, salvation is by blind faith, and sometimes by <a href="#dead">the false assurance of a dead faith</a>. I view these teachings as flirting with the heresy of [antinomianism](https://sevenshepherd.github.io/antinomian-heresy/).
- ✅ In my theology salvation is prescient upon reciprocated love within genuine saving faith. The heart change and dispostion that makes faith genuine (beyond works or choice). So then salvation is neither by random selection nor by human decision, but instead salvation is by faith alone.

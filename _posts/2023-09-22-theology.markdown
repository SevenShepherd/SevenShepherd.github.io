...
- We're saved by grace through faith (Eph. 2:8-9), so faith must have something to do with the election process, the only thing I'd point out is that it's not the willing or the action, but the heart change and reciprocation.
- &ldquo;Free will carried many a soul to hell, but never a soul to heaven.&rdquo; &mdash; Spurgeon

This is a theory still under development. I want to "marry" this idea with a hypothetical universalist system (Les hypothètiques) or amyraldianism. This is not an anti-free will theory per se, it just doesn't need it to satisfy the requirements.

...
The only difference between moderately arminian compatibilists and the <a href="#mod-reformed-compat">moderately reformed compatibilists</a>, is that this group bases election on foreknowledge of forseen faith. The other group does not.

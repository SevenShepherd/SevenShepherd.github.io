...
- 🟦 <a href="" style="font-weight:bold;color:link;">Blue is an acceptable stance.</a>
- 🟥 <span style="font-weight:bold;color:darkred;">Red is an unacceptable stance.</span>
- 🟪 <span style="font-weight:bold;color:purple;">Purple marks scientist theologians.</span>
...
2. <a href="#conditional">**Conditional Election (Foreknowledge)**</a>
    - 2.1 <a href="#classical-arminian">Classical Arminianism</a>
...
<a name="mod-reformed-compat" href="#contents" style="font-size:1.6em;">1.1.5 Moderate Reformed Compatibilism</a>

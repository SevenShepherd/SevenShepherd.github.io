...
1. <a href="#single">Unconditional Single Election (Foreordination)</a>
    - 1.1 <a href="#moderate-reformed">Moderately Reformed</a>
        ...
        - 1.1.3 <a href="#mod-reformed-compat" style="font-weight:bold;color:SteelBlue;">Compatibilism</a>
            - 1.1.3.1 ⭐ <a href="#ross" style="font-weight:bold;color:SeaGreen;">Dr. Ross (Toronto)</a>
            - 1.1.3.2 ⭐ <a href="#carson" style="font-weight:bold;color:SteelBlue;">Dr. Carson (Cambridge)</a>
                - 1.1.3.2.1 <a href="#men-as-responsible" style="font-weight:bold;color:SteelBlue;">Men As Responsible</a>
                - 1.1.3.2.2 <a href="#god-as-sovereign" style="font-weight:bold;color:SteelBlue;">God As Sovereign</a>
...
2. <a href="#conditional">Conditional Election (Foreknowledge)</a>
    ...
    - 2.2 <a href="#systemless">Systemless / Armin.</a>
        ...
        - 2.2.2 <a href="#heiser" style="font-weight:bold;color:SteelBlue;">Dr. Heiser (Wisconsin)</a>
    - 2.3 <a href="#moderate-arminian">Reformed Arminianism</a> ([link](https://www.gotquestions.org/Reformed-Arminianism.html))
        ...
        - 2.3.2 <a href="#mod-arm-eternal" style="font-weight:bold;color:SteelBlue;">Reformed Armin. w/ Eternal Sec.</a>
            - 2.3.2.1 <a href="#smith" style="font-weight:bold;color:SteelBlue;">⭐ Chuck Smith</a>

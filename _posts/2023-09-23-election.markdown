...
- <a name="faith_grudem" href="#contents" style="font-size:1.6em">1.2 The Definition Of Faith According To Grudem</a>
    ...
    You can read the full description [here](https://sevenshepherd.github.io/practicing-sin/#grudem).
...
- <a name="faith_analysis" href="#contents" style="font-size:1.6em">1.3 Is Faith is a "universal" God-given ability?</a>

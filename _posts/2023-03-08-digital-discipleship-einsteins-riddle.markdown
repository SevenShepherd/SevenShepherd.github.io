...
date: 2023-03-08 01:00:00 -0500
categories: logic riddle einstein
published: true
---


This is an **intermediate** exercise written for the Digital discipleship program created by SevenShepherd. If you are new or haven't gone through our fundamentals course, please check that out before attempting to understand this exercise.

This is a fun puzzle that was allegedly created by Albert Einstein as a boy. Einstein said that only 2% of the world could solve it. Considering that there are 5!^5 or 24,883,200,000 combinations with only 1 correct solution, you might find the task daunting but I can assure you that anyone who has gone through our class can understand all 3 solutions below.
